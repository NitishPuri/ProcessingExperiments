...
let key = 'AIzaSyDuHz7XCoIz9BSMm6u2cUrMnGwpFvCt4Qw'
...
function newDrawing() {
  const url = `https://quickdrawfiles.appspot.com/drawing/${params.category}?isAnimated=false&format=json&key=${key}`
  // loadJSON(url + key, gotDrawing);
